...
// --------------------------------------------------------------------------------
SetViewportCommand::SetViewportCommand(i32 xpos, i32 ypos, i32 width,
                                       i32 height)
...
// --------------------------------------------------------------------------------
DrawCommand::DrawCommand(const VertexArray *va, u32 offset, u32 vertCount,
                         PrimitiveType topology, const Mat4 &model)
    : m_VAO(va), m_Transform(model), m_VertOffset(offset),
      m_NumVertices(vertCount), m_Topology(topology) {}
// --------------------------------------------------------------------------------
...
// --------------------------------------------------------------------------------
DrawIndexedCommand::DrawIndexedCommand(const VertexArray *va, u32 idxOffset,
                                       u32 idxCount, const Mat4 &model,
                                       PrimitiveType topology)
    : m_VAO(va), m_Transform(model), m_IndexOffset(idxOffset),
      m_NumIndex(idxCount), m_Topology(topology) {}
// --------------------------------------------------------------------------------
...
// --------------------------------------------------------------------------------
ClearCommand::ClearCommand(const Color &color) : m_Color(color) {}
// --------------------------------------------------------------------------------
void ClearCommand::Execute(RenderSystem &renderSys) const {
  renderSys.Clear(m_Color);
}
// --------------------------------------------------------------------------------
